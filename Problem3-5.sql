...
BEGIN
    ...
    DECLARE newItemAmount DECIMAL(10,2);
    SELECT line_item_amount
    INTO newItemAmount FROM invoice_line_items
    WHERE invoice_id = new.invoice_id
    HAVING max(invoice_sequence);
   	UPDATE invoices SET invoice_total = (invoice_total + newItemAmount) 
